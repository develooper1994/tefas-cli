...
/// Real TEFAS fund detail pages. The files live in datasets/fundpage and are
/// embedded at compile time so file I/O does not pollute parser timings.
const FUND_PAGES: &[(&str, &str)] = &[
    (
        "AC5",
        include_str!("../../../datasets/fundpage/html/AC5.html"),
    ),
    (
        "ADE",
        include_str!("../../../datasets/fundpage/html/ADE.html"),
    ),
    (
        "AFT",
        include_str!("../../../datasets/fundpage/html/AFT.html"),
    ),
    (
        "AGC",
        include_str!("../../../datasets/fundpage/html/AGC.html"),
    ),
    (
        "DGF",
        include_str!("../../../datasets/fundpage/html/DGF.html"),
    ),
    (
        "DTZ",
        include_str!("../../../datasets/fundpage/html/DTZ.html"),
    ),
    (
        "EML",
        include_str!("../../../datasets/fundpage/html/EML.html"),
    ),
    (
        "MTV",
        include_str!("../../../datasets/fundpage/html/MTV.html"),
    ),
    (
        "TAR",
        include_str!("../../../datasets/fundpage/html/TAR.html"),
    ),
    (
        "TGR",
        include_str!("../../../datasets/fundpage/html/TGR.html"),
    ),
    (
        "TLY",
        include_str!("../../../datasets/fundpage/html/TLY.html"),
    ),
    (
        "VCY",
        include_str!("../../../datasets/fundpage/html/VCY.html"),
    ),
    (
        "ZFB",
        include_str!("../../../datasets/fundpage/html/ZFB.html"),
    ),
];
