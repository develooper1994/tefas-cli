...
**Paket adı:** `tefas-parser` &nbsp;·&nbsp; **Dizin:** `crates/parser`
...
`AC5` / `AFT` / `TLY` gerçek fon sayfası fixture'ları `../../datasets/fundpage` altındadır ve benchmarkta `include_str!` ile gömülür.
